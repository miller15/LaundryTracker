...
/*        if (item != null) {
        	...
        	// this is where we can ask the user if they want to enter a new name - probably make them press enter first and then ask them if 
        	//     they want to add a new person.
